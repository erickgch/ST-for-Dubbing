# improvements with respect to nbest-syllables: for each source segment, if no hypothesis with the same number of 
    # syllables is found within the first 25, take the best ranked hypothesis (regardless of its number of syllables). 
...
with open('nbest-syllables-2.txt', 'w') as f:
    for item in bests:
        f.write("%s\n" % item)
